"""
Source: https://stable-baselines3.readthedocs.io/en/master/_modules/stable_baselines3/common/vec_env/vec_normalize.html
Using an old version of Python 3.6.9, so I can't use the latest version of stable-baselines3.
"""
...
class VecNormalize(VecEnvWrapper):
    ...
    def __init__(
        ...
        # TODO, fill with default reward_range
